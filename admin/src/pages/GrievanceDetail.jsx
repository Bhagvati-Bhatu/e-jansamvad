...
function GrievanceDetail() {
    ...
    useEffect(() => {
        const fetchGrievance = async () => {
            try {
                const response = await fetch(`https://line-host-rt77.onrender.com/grievance/grievanceCode/${grievanceCode}`, {
                    method: "GET",
    ...
    const showFile = async () => {
        try {
            const response = await fetch(`https://line-host-rt77.onrender.com/download/${grievance.fileName}`, {
                method: "GET",
            });
