...
function GrievanceDetail() {
    ...
    useEffect(() => {
        const fetchGrievance = async () => {
            try {
                const response = await fetch(`https://e-jansamvad-1.onrender.comgrievance/grievanceCode/${grievanceCode}`, {
                    method: "GET",
    ...
    const showFile = async () => {
        try {
            const response = await fetch(`https://e-jansamvad-1.onrender.comdownload/${grievance.fileName}`, {
                method: "GET",
            });
