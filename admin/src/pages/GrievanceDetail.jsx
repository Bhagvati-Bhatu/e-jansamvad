...
function GrievanceDetail() {
    ...
    const fetchGrievance = async () => {
      try {
        const response = await fetch(
          `https://e-jansamvad-1.onrender.com/grievance/grievanceCode/${grievanceCode}`,
          {
            method: "GET",
  ...
  const showFile = async () => {
    try {
      const response = await fetch(`https://e-jansamvad-1.onrender.com/download/${grievance.fileName}`, {
        method: "GET",
      });
